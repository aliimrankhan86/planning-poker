...
|---|---|---|
| `src/App.js` | The entire app: CSS string, all components, all Firebase logic | 376 KB |
...
| `src/design-system/components.css` | The `pp-` component classes | 69 KB |
| `src/design-system/index.js` | The React components. Import from here | 40 KB |
...
`npm test` — 283 test blocks across AdminDashboard.test.js, App.test.js, AppErrorBoundary.test.js, design-system/design-system.test.js, designsystem.test.js, estimation.test.js (more cases
