...
|---|---|---|
| `src/App.js` | The entire app: CSS string, all components, all Firebase logic | 388 KB |
...
`npm test` — 288 test blocks across AdminDashboard.test.js, App.test.js, AppErrorBoundary.test.js, design-system/design-system.test.js, designsystem.test.js, estimation.test.js (more cases
